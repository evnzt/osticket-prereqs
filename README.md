...
- Extract the **_"upload"_** folder from **_"osTicket"_** folder to:
   
    ```cmd
   C:\inetpub\wwwroot
   ```
- Rename the newly extracted **_"upload"_** folder within:
...
- Under **_”Enter the object name to select”_** field, write:
   
    ```cmd
   YOUR DESIRED USER HERE
   ```
   Then click **_”Check Names”_** → **_”OK”_**
...
- Delete the setup folder:
   ...
   ```
- Set Permissions to **_“Read”_** only:
